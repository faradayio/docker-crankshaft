...
def spatial_markov_trend(subquery, time_cols, num_classes=7,
    ...
    """
        ...
        1. history of its transitions to different classes
           (e.g., 1st quantile -> 2nd quantile)
    ...
    s_markov = ps.Spatial_Markov(t_data,
                                 weights,
                                 k=num_classes,
                                 fixed=False,
