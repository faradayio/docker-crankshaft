...
class SpaceTimeTests(unittest.TestCase):
    ...
    def test_spatial_markov(self):
        ...
        result = std.spatial_markov_trend(
          'subquery',
    ...
    def test_get_time_data(self):
        ...
        expected = json.loads(
          open(fixture_file('markov_get_time_data.json')).read())
    ...
    def test_rebin_data(self):
        ...
        self.assertTrue(
          np.array_equal(
            std.rebin_data(self.time_data, 3),
            ans_odd))
    ...
    def test_get_prob_dist(self):
        ...
        result = std.get_prob_dist(
          self.transition_matrix, lag_indices, unit_indices)
    ...
    def test_get_prob_stats(self):
        ...
        answer_trend = np.array(
          [-0.03301887 / 0.88207547,
           -0.05882353 / 0.87058824,
           0.02475248 / 0.77722772,
           -0.02352941 / 0.97647059])
        answer_volatility = np.array(
          [0.34221495,
           0.33705421,
           0.29226542,
           0.38834223])
